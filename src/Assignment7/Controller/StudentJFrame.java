...
import Assignment7.Dao.StudentDAO;
...
public class StudentJFrame extends javax.swing.JFrame {
    ...
    public StudentJFrame() {
        ...
        int index_ = 2021;
        DefaultComboBoxModel<String> comboBoxModel_ = (DefaultComboBoxModel<String>) cbDateStudent.getModel();
        comboBoxModel_.removeAllElements();
        for (int i = 0; i < 120; i++) {
            index_--;
            comboBoxModel_.addElement(String.valueOf(index_));
        }
        ...
        tableStudent.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Student student = (Student) isList.get(index);
    ...
    private void initComponents() {
        ...
        tableStudent.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stt", "Id student", "Name class", "Name student", "Age student", "Date student", "Gender student", "Address student", "Phone student"
            }
        ) {
        ...
        cbDateStudent.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        cbDateStudent.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cbDateStudent.setBorder(javax.swing.BorderFactory.createEtchedBorder());
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(cbDateStudent, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                .addContainerGap())
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(175, 175, 175)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel6)
                            .addComponent(cbDateStudent, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
                .addComponent(lbAge)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        // TODO add your handling code here:  
            ...
            String genderStudent = "Nam";
            if (radioFamale.isSelected()) {
                genderStudent = "Nu";
            }
            int ageStudent = Integer.parseInt(txtAgeStudent.getText());
            String dateStudent = cbDateStudent.getSelectedItem().toString();
            ...
            Student student =new Student( idStudent, nameStudent, ageStudent, dateStudent, genderStudent, addressStudent, phoneStudent, idClass);
        ...
        if (connection != null) {
            ...
            try {
                ...
                preparedStatement = connection.prepareStatement(sql);
                    ...
                    String dateStudent = (String) cbDateStudent.getSelectedItem();
                    Classs classs = (Classs) isList.get(_index);
                    preparedStatement.setString(1, txtNameStudent.getText());
                    preparedStatement.setInt(2, Integer.parseInt(txtAgeStudent.getText()));
                    preparedStatement.setString(3, dateStudent);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (input != null && input.length() > 0) {
            isList = StudentDAO.searchByName(input);
            tableModel.setRowCount(0);
