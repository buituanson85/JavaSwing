...
import Assignment7.Dao.MarkDAO;
...
//            String idSub = txtIdSub.getText();
            ...
            if (idStudent.isEmpty() || idSub.isEmpty() || idSem.isEmpty() || _pga.isEmpty()
                ...
                if (Integer.parseInt(txtPga.getText()) < 0 || Integer.parseInt(txtPga.getText()) > 10) {
                    ...
                    MarkDAO.create(idStudent, idSub, idSem, pga);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (connection != null) {
            ...
            try {
                String sql = "EXEC update_mark_by_idSub @idStudent = ?, @idSem = ?, @pga = ?, @idSub = ?";
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (input != null && input.length() > 0) {
            isList = MarkDAO.searchByName(input);
            tableModel.setRowCount(0);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (index >= 0) {
            Mark mark = (Mark) isList.get(index);
            int option = JOptionPane.showConfirmDialog(this, "Bạn có muốn xóa id này không");
