...
public class Student extends Programa implements ISchool{
    ...
    public Student(String id, String nameClass, String name,int ageStudent, String dateStudent, String genderStudent, String addressStudent, String phoneStudent) {
        super(id, name);
        this.nameClass = nameClass;
        this.ageStudent = ageStudent;
        this.dateStudent = dateStudent;
