    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        // TODO add your handling code here:  
            ...
            if(txtIdStudent.getText().isEmpty() || txtNameStudent.getText().isEmpty() 
                    || txtAddressStudent.getText().isEmpty() || txtPhoneStudent.getText().isEmpty()){
                ...
                while (true) {                    
                    for (Iterator<ISchool> it = isList.iterator(); it.hasNext();) {
                        ...
                        if (student.getId().equalsIgnoreCase(txtIdStudent.getText())) {
                            lbStudentId.setText("id already exists");
                            break;
                        }else{
